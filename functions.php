...
function send_email($from, $from_name, $to, $to_name, $subject, $message, $plain_text_message='', $cc_emails=null, $bcc_emails=null) {
	...
	if($mailstatus['success'] != 1) {
		...
		if( (is_array($cc_emails)) AND (count(array($cc_emails > 0))) ) {
		...
		if( (is_array($bcc_emails)) AND (count(array($bcc_emails > 0))) ) {
...
function _send_api($from, $from_name, $to, $to_name, $subject, $message, $plain_text_message, $msgTo) {
	...
	try {
		...
		$post = array(
			...
			'apikey'          => '058113C3DD710E097C57209EC79312E0504B23E81563BF52F96251EE35436BF2CD7BA846ACBA7EB5390D9596EC6356BD',
